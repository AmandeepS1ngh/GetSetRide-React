...
const EditCarPage = () => {
    ...
    useEffect(() => {
        const fetchCarDetails = async () => {
            try {
                ...
                if (!token) {
                    setError('Please login to edit your car');
    ...
    const handleSubmit = async (e) => {
        ...
        const token = localStorage.getItem('authToken') || localStorage.getItem('token');
        if (!token) {
            setError('You must be logged in to edit a car. Redirecting to login...');
            setTimeout(() => navigate('/login'), 2000);
            return;
        }
        ...
        try {
            ...
            setSuccess('Car details updated successfully! Redirecting...');
                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="mb-10 text-center">
                        <div className="inline-flex items-center justify-center p-3 bg-blue-50 rounded-full mb-4">
                            <span className="material-icons text-3xl text-blue-600">edit_note</span>
                        </div>
                        <h1 className="text-4xl font-bold text-gray-900 mb-3">Edit Car Details</h1>
                        <p className="text-lg text-gray-500 max-w-2xl mx-auto">Update information about your car listing.</p>
                    </div>
                            ...
                            <section>
                                ...
                                <div className="pl-0 md:pl-14">
                                    <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center mb-6 hover:bg-gray-100 transition-colors cursor-pointer" onClick={handleImageUrlAdd}>
                                        ...
                                        <p className="text-gray-500 text-sm mt-1">Click to enter URL</p>
                                    </div>
